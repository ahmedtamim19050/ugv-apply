                ...
                <div class="row justify-content-md-start  justify-content-sm-center g-5">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-10">
                        <div class="single-contact">
                            <div class="single-contact__single">
                                ...
                                <div class="method">
                                    <p>01877774050,01877774064, 01870802814, 01870802815</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-10">
                        <div class="single-contact">
                            <div class="single-contact__single">
                                <div class="icon">
                                    {{-- <svg width="64" height="64" viewBox="0 0 47 39" fill="none"
        ...
        <div class="container">
            <div class="row">
                <div class="rts-seciton rt-center mb--40">
                    <h2 class="rts__section--title text-capitalize">Talk To Us Today</h2>
                </div>
            </div>
                    ...
                    <div>
                        <form action="">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" rows="3" placeholder="Your Message" style="border: 1px solid grey; box-shadow: none;"></textarea>
                                </div>
                                
                                <div class="text-end">
                                    <button type="submit" class="rts-theme-btn">Send Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
